...
<%@ page
	import="java.util.*, seoulmate.board.UserBoardDAO, seoulmate.board.UserBoardDTO"%>
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<div class="card shadow mb-4 card-large">
								<!-- 카드 크기를 키우기 위해 card-large 클래스 추가 -->
								<div class="card-header py-3">
									<h5 class="m-0 font-weight-bold text-primary">유저공유게시판</h5>
									<!-- 카드 제목 -->
								</div>
								<div class="card-body card-body-large">
									<!-- 카드 본문의 크기를 키우기 위해 card-body-large 클래스 추가 -->
